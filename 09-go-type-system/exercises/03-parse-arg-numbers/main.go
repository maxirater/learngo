...
func main() {
	...
	vale, _ := strconv.ParseInt(os.Args[1], 10, 8)
	...
	// either -128 or 127.
	fmt.Println("int8 value is:", int8(vale))
	p := fmt.Println
	// --------------------------------------
	// NOW IT'S YOUR TURN!
	// --------------------------------------
	...
	//    Should print: 4
	val8b, _ := strconv.ParseInt(os.Args[4], 2, 8)
	p(val8b)
}
